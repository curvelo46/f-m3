...
# Thread-local storage para conexiones por hilo
_thread_local = threading.local()

def get_db():
    """Obtiene la conexión a la base de datos (una por hilo)."""
    if not hasattr(_thread_local, 'connection') or _thread_local.connection is None:
        _thread_local.connection = sqlite3.connect(Config.DB_NAME)
...
def init_db():
    ...
    CREATE TABLE IF NOT EXISTS errores_sistema (
        ...
        url TEXT,
        metodo TEXT,
        estado TEXT DEFAULT 'No resuelto'
    );
    """)
    ...
    # --- TRIGGERS PARA registros (INSERT, UPDATE, DELETE) ---
...
# ============================================================
# FUNCIONES DE SESIÓN (compatibles con database.py)
# ============================================================
